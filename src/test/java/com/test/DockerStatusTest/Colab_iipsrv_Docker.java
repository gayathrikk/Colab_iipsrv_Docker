...
public class Colab_iipsrv_Docker{
    ...
    public void colab_iipsrv_Status() {
        ...
        String containerId = "15520cd7c8d8";

        System.out.println("colab iipsrv Docker ID = " + containerId);
        ...
        try {
            ...
            if (!isRunning) {
                sendEmailAlert("Hi,\n\n🚨 This is colab iipsrv Docker. I am currently down. Kindly restart the container at your earliest convenience.");
    ...
    public void sendEmailAlert(String messageBody) {
        ...
        String subject = "Docker Container Alert - colab iipsrv docker";
